...
class DomainValueRepositoryTest {
	...
	public void setUp() {
	 ...
	 @DisplayName("Test: When find values of domain with it id returns a list with its domain values")
	 @Test
	 ...
	 @DisplayName("Test: When find value of domain with it id returns empty list because not exists values for it domain")
	 @Test
	 ...
	 public void whenFindValueOfDomainWithId() {
		 ...
		 Optional<DomainValue> domainValue = domainValueRepository.findById(domainValue1.getDomainValueId());
